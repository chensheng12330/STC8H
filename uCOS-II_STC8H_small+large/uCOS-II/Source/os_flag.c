...
static  void     OS_FlagBlock(OS_FLAG_GRP *pgrp, OS_FLAG_NODE *pnode, OS_FLAGS flags, INT8U wait_type, INT32U timeout)FunctionProperties;
static  BOOLEAN  OS_FlagTaskRdy(OS_FLAG_NODE *pnode, OS_FLAGS flags_rdy, INT8U pend_stat)FunctionProperties;
...
OS_FLAGS  OSFlagPost_FROM_ISR (OS_FLAG_GRP  *pgrp,
                      OS_FLAGS      flags,
                      INT8U         opt,
                      INT8U        *perr)FunctionProperties
{
...
static  void  OS_FlagBlock (OS_FLAG_GRP  *pgrp,
                            ...
                            OS_FLAGS      flags,
                            INT8U         wait_type,
                            INT32U        timeout)FunctionProperties
{
