...
#if OS_TMR_EN > 0u
static  OS_TMR  *OSTmr_Alloc         (void)FunctionProperties;
static  void     OSTmr_Free          (OS_TMR *ptmr)FunctionProperties;
static  void     OSTmr_InitTask      (void)FunctionProperties;
static  void     OSTmr_Link          (OS_TMR *ptmr, INT8U type)FunctionProperties;
static  void     OSTmr_Unlink        (OS_TMR *ptmr)FunctionProperties;
static  void     OSTmr_Task          (void   *p_arg)large;
#endif
...
INT8U  OSTmrSignal (void)FunctionProperties
{
    ...
    err = OSSemPost_FROM_ISR(OSTmrSemSignal);
    return (err);
}
#endif
