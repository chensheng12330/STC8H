...
static  void  OS_InitEventList(void)FunctionProperties;

static  void  OS_InitMisc(void)FunctionProperties;

static  void  OS_InitRdyList(void)FunctionProperties;

static  void  OS_InitTaskIdle(void)FunctionProperties;

#if OS_TASK_STAT_EN > 0u
static  void  OS_InitTaskStat(void)FunctionProperties;
#endif

static  void  OS_InitTCBList(void)FunctionProperties;

static  void  OS_SchedNew(void)FunctionProperties;
...
//    OS_CPU_SR  cpu_sr = 0u;
    ...
    /*OS_ENTER_CRITICAL();  */EA=0;                                 /* Update the 32-bit tick counter               */
    OSTime++;
