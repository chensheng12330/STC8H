...
#define	YEAR		(*(unsigned char volatile xdata *)0xfe70)	/* RTC的年计数值 */
#define	MONTH		(*(unsigned char volatile xdata *)0xfe71)	/* RTC的月计数值 */
#define	DAY			(*(unsigned char volatile xdata *)0xfe72)	/* RTC的日计数值 */
#define	HOUR		(*(unsigned char volatile xdata *)0xfe73)	/* RTC的时计数值 */
#define	MIN			(*(unsigned char volatile xdata *)0xfe74)	/* RTC的分计数值 */
#define	SEC			(*(unsigned char volatile xdata *)0xfe75)	/* RTC的秒计数值 */
#define	SSEC		(*(unsigned char volatile xdata *)0xfe76)	/* RTC的1/128秒计数值 */
...
#define	PWMA_EGR	(*(unsigned char volatile xdata *)0xfec7)	/* PWMA时件发生寄存器  */
...
#define	PWMB_EGR	(*(unsigned char volatile xdata *)0xfee7)	/* PWMB时间发生寄存器  */
