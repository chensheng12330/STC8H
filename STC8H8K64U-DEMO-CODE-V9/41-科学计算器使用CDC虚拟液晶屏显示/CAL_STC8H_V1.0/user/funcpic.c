...
double xdata fUNC_X0=63;
double xdata fUNC_Y0=31;
double xdata fUNC_KX=1;
double xdata fUNC_KY=1;

u8 xdata funcstr[26];
u8 xdata funcstrlength;
u8 xdata funcstraddr;
u8 xdata shift_flagf=0;
void FuncPic_SetX0(u8 keynum)
{
    static u8 xdata keynum_last;
    switch( state )
    {
        case 0://初始化
            Screen_Clear();
